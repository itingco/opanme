...
class StockOpnameCycle extends Model
{
    ...
    use HasFactory;
    public const STATUS_DRAFT='DRAFT'; public const STATUS_OPEN='OPEN'; public const STATUS_CLOSED='CLOSED';
    public const DB_INGCO='AS_INGCO'; public const DB_SMI='AS_SMI';
    protected $fillable=['cycle_no','source_database','cutoff_date','status','started_at','completed_at','closing_snapshot_at','closing_snapshot_error','created_by'];
    protected $casts = ['cutoff_date'=>'date','started_at'=>'datetime','completed_at'=>'datetime','closing_snapshot_at'=>'datetime'];
